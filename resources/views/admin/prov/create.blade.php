...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-material mt-4" action="{{ route("admin.provinsi.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group {{ $errors->has('zona_waktu') ? 'has-error' : '' }}">
                ...
                <select name="zona_waktu" id="zona_waktu" class="form-control select2" required style="width: 100%; height:36px;">
                    ...
                    <option value="01">Waktu Indonesia Barat</option>
                    <option value="02">Waktu Indonesia Tengah</option>
                    <option value="03">Waktu Indonesia Timur</option>
                </select>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group {{ $errors->has('id_prov') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="id_prov" name="id_prov" class="form-control" value="{{ old('id_prov', '') }}">
