...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-material mt-4" action="{{ route("admin.kecamatan.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group {{ $errors->has('kecamatan') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="id_kec" name="id_kec" class="form-control" value="{{ old('id_kec', '') }}">
